        ...
        if (needsSEO) {
          try {
            ...
            if (isValidSEODescription(seoDescription)) {
              ...
              console.log(`[DealerSocket Sync] SEO description generated for ${vehicle.VIN}`);
            }
          } catch (seoErr: any) {
            console.error(`[DealerSocket Sync] SEO generation failed for ${vehicle.VIN}:`, seoErr.message);
