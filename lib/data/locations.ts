...
export const locations = {
  ...
  'germantown': { city: 'Germantown', state: 'Maryland', stateCode: 'MD', lat: 39.1732, lng: -77.2717 },
...
// Location slugs as array for easier iteration
export const locationSlugs = Object.keys(locations);

// Type for location data
export type LocationData = typeof locations[keyof typeof locations];
