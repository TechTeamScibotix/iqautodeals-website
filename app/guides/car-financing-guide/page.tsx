        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-blue-50 rounded-lg p-6 mb-8">
              <h3 className="text-xl font-bold text-dark mb-4">The 20/4/10 Rule</h3>
              <ul className="space-y-2">
                <li><strong>20% Down:</strong> Put down at least 20% to avoid being underwater</li>
                <li><strong>4 Years Max:</strong> Finance for no more than 48 months</li>
                <li><strong>10% of Income:</strong> Total car expenses under 10% of gross monthly income</li>
              </ul>
            </div>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-primary pl-6">
                <h3 className="text-xl font-bold text-dark mb-2">1. Check and Improve Your Credit Score</h3>
              ...
              <div className="border-l-4 border-primary pl-6">
                <h3 className="text-xl font-bold text-dark mb-2">2. Shop Multiple Lenders</h3>
              ...
              <div className="border-l-4 border-primary pl-6">
                <h3 className="text-xl font-bold text-dark mb-2">3. Get Pre-Approved</h3>
                <p className="text-gray-700">
              ...
              <div className="border-l-4 border-primary pl-6">
                <h3 className="text-xl font-bold text-dark mb-2">4. Negotiate the Purchase Price First</h3>
                <p className="text-gray-700">
              ...
              <div className="border-l-4 border-primary pl-6">
                <h3 className="text-xl font-bold text-dark mb-2">5. Read All Documents Carefully</h3>
                <p className="text-gray-700">
            ...
            <div className="bg-red-50 rounded-lg p-6 mb-8">
              <ul className="space-y-3">
                <li><strong>✗ Focusing only on monthly payment:</strong> Longer loans mean more interest paid</li>
                <li><strong>✗ Accepting first offer:</strong> Always shop around and compare at least 3 lenders</li>
                <li><strong>✗ Not reading the fine print:</strong> Watch for prepayment penalties and fees</li>
                <li><strong>✗ Financing the full price:</strong> Put down at least 10-20% to save on interest</li>
                <li><strong>✗ Extending the loan term:</strong> 72-84 month loans cost thousands more in interest</li>
              </ul>
            </div>
            ...
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse border border-gray-300">
                <thead className="bg-gray-100">
                  <tr>
                    <th className="border border-gray-300 px-4 py-3 text-left">Credit Score</th>
                    <th className="border border-gray-300 px-4 py-3 text-left">New Car Rate</th>
                    <th className="border border-gray-300 px-4 py-3 text-left">Used Car Rate</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-green-50">
                    <td className="border border-gray-300 px-4 py-3">781-850 (Excellent)</td>
                    <td className="border border-gray-300 px-4 py-3">4.5% - 6%</td>
                    <td className="border border-gray-300 px-4 py-3">5.5% - 7.5%</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-3">661-780 (Good)</td>
                    <td className="border border-gray-300 px-4 py-3">6% - 8%</td>
                    <td className="border border-gray-300 px-4 py-3">7.5% - 10%</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-3">601-660 (Fair)</td>
                    <td className="border border-gray-300 px-4 py-3">9% - 13%</td>
                    <td className="border border-gray-300 px-4 py-3">10% - 15%</td>
                  </tr>
                  <tr className="bg-red-50">
                    <td className="border border-gray-300 px-4 py-3">500-600 (Poor)</td>
                    <td className="border border-gray-300 px-4 py-3">14% - 18%</td>
