        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-blue-50 rounded-lg p-6 mb-6">
              ...
              <p className="font-semibold text-dark">Top Reliable Brands: Toyota, Honda, Mazda, Lexus, Subaru</p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 mb-6">
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mt-4">
                <p className="text-sm"><strong>Pro Tip:</strong> Credit unions typically offer 1-2% lower rates than dealerships.</p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 mb-6">
              ...
              <p className="text-gray-700 mb-4">
                <strong>Never skip this step!</strong> Pay a mechanic $100-150 to inspect the car. They'll find issues you'd miss and can save you thousands in future repairs.
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-6 mb-6">
              ...
              <div className="bg-green-50 p-4 rounded mt-4">
                <p className="font-semibold text-dark mb-2">Negotiation Tips:</p>
                <ul className="text-sm space-y-1">
