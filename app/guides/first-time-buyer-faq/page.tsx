...
import { HelpCircle, CheckCircle, AlertTriangle, DollarSign } from 'lucide-react';
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  Follow the <strong className="text-white">20/4/10 rule</strong>: Put 20% down, finance for no more than 4 years, and keep total car costs (payment + insurance + gas + maintenance) under 10% of your gross monthly income. For example, if you make $4,000/month, your total car costs should stay under $400.
                </p>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">Used is almost always better for first-time buyers.</strong> New cars lose 20-30% of value in the first year. A 2-3 year old certified pre-owned car gives you reliability with significant savings. Save "new car" purchases for when you have more financial stability.
                </p>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  Aim for <strong className="text-white">at least 10-20%</strong> of the purchase price. A larger down payment means lower monthly payments, less interest paid, and avoiding being "underwater" (owing more than the car is worth). If you can only afford a small down payment, consider a less expensive car.
                </p>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300 mb-2">Beyond the purchase price, budget for:</p>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <ul className="text-sm space-y-1 text-gray-300">
                  <li>• <strong className="text-white">750+:</strong> Best rates (3-6% APR)</li>
                  <li>• <strong className="text-white">700-749:</strong> Good rates (6-9% APR)</li>
                  <li>• <strong className="text-white">650-699:</strong> Average rates (9-13% APR)</li>
                  <li>• <strong className="text-white">600-649:</strong> Subprime (13-18% APR)</li>
                  <li>• <strong className="text-white">Below 600:</strong> Deep subprime (18%+ APR)</li>
                </ul>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">Absolutely yes!</strong> Pre-approval from your bank or credit union gives you negotiating power, shows dealers you're serious, and protects you from dealer financing markups. Apply to 2-3 lenders within 14 days (counts as one credit inquiry).
                </p>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">48 months (4 years) or less is ideal.</strong> Longer loans (60, 72, 84 months) have lower payments but cost thousands more in interest and leave you underwater longer. If you need a 72+ month loan to afford the payment, the car is too expensive.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300 mb-2">Each option has pros and cons:</p>
                <ul className="text-sm space-y-1 text-gray-300">
                  <li>• <strong className="text-white">Franchised dealer:</strong> CPO options, financing, but higher prices</li>
                  <li>• <strong className="text-white">Independent dealer:</strong> Lower prices, less selection</li>
                  <li>• <strong className="text-white">CarMax/Carvana:</strong> No-haggle, easy process, fair prices</li>
                  <li>• <strong className="text-white">Private seller:</strong> Best prices, but more risk and no warranty</li>
                </ul>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300 mb-2">Follow these rules:</p>
                <ul className="space-y-1 text-gray-300">
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Know the fair market value before you go (KBB, Edmunds)</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Focus on OUT-THE-DOOR price, not monthly payment</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Be willing to walk away - there are always other cars</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Get quotes from 3+ dealers via email first</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Don't reveal your budget or monthly payment target</span></li>
                </ul>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300 mb-2">Test drive for at least 20-30 minutes and check:</p>
                <ul className="space-y-1 text-gray-300">
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">Yes, for any used car!</strong> Pay $100-150 for a mechanic to inspect it. They'll find issues you'd miss and can save you thousands. Skip this only for CPO cars with warranty. If a seller refuses an inspection, walk away.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  <strong className="text-white">Before you drive off the lot.</strong> Get insurance quotes while shopping and have a policy ready to activate. Most dealers won't let you leave without proof of insurance. Your current policy (if any) may cover a new purchase for a few days - check with your insurer.
                </p>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <ul className="space-y-1 text-gray-300">
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Stay on parents' policy if possible</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Take a defensive driving course</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Choose a car with good safety ratings</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Avoid sports cars and luxury vehicles</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-green-400 mt-0.5" /><span>Good student discount (if applicable)</span></li>
                </ul>
              </div>
              ...
              <div className="bg-black rounded-xl p-6">
                ...
                <p className="text-gray-300 mb-2">Look for reliability, safety, and low cost of ownership:</p>
                <ul className="space-y-1 text-gray-300">
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-primary mt-0.5" /><span><strong className="text-white">Honda Civic/Accord:</strong> Reliable, holds value, affordable parts</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-primary mt-0.5" /><span><strong className="text-white">Toyota Corolla/Camry:</strong> Legendary reliability, low maintenance</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-primary mt-0.5" /><span><strong className="text-white">Mazda3:</strong> Fun to drive, reliable, great value</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-primary mt-0.5" /><span><strong className="text-white">Hyundai Elantra:</strong> Great warranty, affordable</span></li>
                  <li className="flex gap-2"><CheckCircle className="w-5 h-5 text-primary mt-0.5" /><span><strong className="text-white">Subaru Impreza:</strong> AWD, safe, reliable</span></li>
                </ul>
              </div>
            </div>
